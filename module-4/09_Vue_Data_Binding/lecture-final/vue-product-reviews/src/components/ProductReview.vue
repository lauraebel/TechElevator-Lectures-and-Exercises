<template>
    <div class="main">
        ...
        <div class="review" v-for="review in reviews" v-bind:key="review.id">
            <h4 v-bind:class="{'verifiedReviewer' : review.verifiedReviewer}">{{ review.reviewer }}</h4>
            <h6 v-if="review.verifiedReviewer">Verified Reviewer</h6>
            <div class="rating">
...
export default {
    ...
    computed: {
        // vm - view model, gives us access to the data()
        averageRating(vm) {

...
public class ExercisesTest {
	...
	public void distinctValues() {
		List<String> output = exercises.distinctValues(
				new ArrayList<String>(Arrays.asList("red", "yellow", "green", "yellow", "blue", "green", "purple")));
		assertThat("distinctValues([\"red\", \"yellow\", \"green\", \"yellow\", \"blue\", \"green\", \"purple\"])",
				output, equalTo(new ArrayList<String>(Arrays.asList("red", "yellow", "green", "blue", "purple"))));

		output = exercises.distinctValues(new ArrayList<String>(
				Arrays.asList("jingle", "bells", "jingle", "bells", "jingle", "all", "the", "way")));
		assertThat(
				"distinctValues([\"jingle\", \"bells\", \"jingle\", \"bells\", \"jingle\", \"all\", \"the\", \"way\"])",
				output, equalTo(new ArrayList<String>(Arrays.asList("jingle", "bells", "all", "the", "way"))));
	}

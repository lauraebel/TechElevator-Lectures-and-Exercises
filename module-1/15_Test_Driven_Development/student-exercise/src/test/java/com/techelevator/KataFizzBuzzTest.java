...
public class KataFizzBuzzTest {
	...
	@Test
	public void num_not_divisible_by_3_or_5_but_below_1_returns_empty_string () {
		String katafb = fizzbuzz.getKata(-4);
		Assert.assertEquals("", katafb);
	}
	@Test
	public void num_not_divisible_by_3_but_contains_a_3_returns_fizz() {
		String katafb = fizzbuzz.getKata(13);
		Assert.assertEquals("Fizz", katafb);
	}
	@Test
	public void num_not_divisible_by_5_but_contains_a_5_returns_buzz() {
		String katafb = fizzbuzz.getKata(51);
		Assert.assertEquals("Buzz", katafb);
	}
	@Test
	public void num_not_divisible_by_3_or_5_but_contains_3_and_5_returns_fizzbuzz() {
		String katafb = fizzbuzz.getKata(53);
		Assert.assertEquals("FizzBuzz", katafb);
	}

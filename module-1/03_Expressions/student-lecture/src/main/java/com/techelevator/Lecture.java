...
public class Lecture {
    ...
    */
	//LEE- empty parentheses means the parameters are 0/no parameters
	//ORIGINAL- public int returnNotOne() {
	//          return 1; }
	//the above fails the test because although it's a valid method, it does not meet the requirements of what you're being asked (not one)
    ...
    */
    //LEE ORIGINAL- public double returnNotHalf() {
    //             return 0.5; }
    ...
    */
    //LEE ORIGINAL- public String returnName() {
    //            return null; }
    ...
    */
    //LEE ORIGINAL- public int returnDoubleOfTwo() {
    //             return 2; }
    ...
    */
    //LEE ORIGINAL- public boolean returnNameOfLanguage() {
    //             return false; }
    ...
    */
    //LEE ORIGINAL- public boolean returnTrueFromIf() {
    //              if (true) {
    //              return false; 
    //          }
    //             return false;
    ...
    */
    //LEE ORIGINAL- public boolean returnTrueWhenOneEqualsOne() {
    //             if (1 == 1) {
    //                return false;
    //         }
    //         return false;
    ...
    * NOT EXCLUSIVE SO NO ELSE NEEDED
    */
...
// OR return number > 17 ? "Adult" : "Minor";
// OR you can remove the else
// OR you can use the Not condition - if ( !(number < 18) )    

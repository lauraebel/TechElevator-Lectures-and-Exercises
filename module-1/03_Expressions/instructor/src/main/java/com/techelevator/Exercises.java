...
//		return 0;
		...
		// a in range and b not in range, return a

		// b in range and a not in range, return b

		// Both in Range, return largest
		// a and b not in range, return 0
	...
	public int caughtSpeeding(int speed, boolean isBirthday) {
		...
		// IF birthday, then subtract 5 from speed so non-birthday calculations will
		// work
	...
	public int teenSum(int a, int b) {
		...
		// If either a or b are in [13-19] then return 19
		// Otherwise return 1 + b
